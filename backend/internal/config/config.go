...
func setDefaults() {
	...
	// Pricing - 从自维护仓库 cc 分支同步模型定价和上下文窗口数据
	viper.SetDefault("pricing.remote_url", "https://raw.githubusercontent.com/xilu0/sub2api/cc/backend/resources/model-pricing/model_prices_and_context_window.json")
	viper.SetDefault("pricing.hash_url", "https://raw.githubusercontent.com/xilu0/sub2api/cc/backend/resources/model-pricing/model_prices_and_context_window.sha256")
	...
	viper.SetDefault("gateway.openai_ws.scheduler_score_weights.priority", 3.0)
